"""Mock drug target records for the MolGenix prototype."""

MOCK_TARGETS: list[dict[str, str]] = [
    {
        "key": "egfr",
        ...
        "description": "Simulated oncology target used to evaluate kinase-like candidate profiles.",
    },
    {
        "key": "jak2",
        "name": "Janus Kinase 2",
        ...
        "description": "Simulated hematology target for balancing potency, selectivity, and safety liabilities.",
    },
    {
        "key": "bace1",
        ...
        "description": "Simulated neuroscience target with emphasis on CNS exposure and polar surface area.",
    },
    {
        "key": "tnf",
        ...
        "description": "Simulated immunology target for prototype ranking of inflammation-focused candidates.",
    },
    {
        "key": "hiv_integrase",
        "name": "HIV Integrase",
        ...
        "description": "Simulated antiviral target with docking scores modeled around integrase active-site binding.",
    },
]
